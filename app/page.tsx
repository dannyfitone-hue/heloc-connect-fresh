        ...
        <section className="process-shell">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-visual mascot-stage" aria-label="HC Hopper, the HELOC CONNECT mascot, waves hello">
              ...
              <div className="mascot-nameplate" aria-hidden="true">
                <span>MEET</span>
                <strong>HC HOPPER</strong>
                <small>Your HELOC CONNECT guide</small>
              </div>
            </div>
          </div>
...
.mascot-stage{display:flex;align-items:center;justify-content:center;padding:18px 18px 64px;isolation:isolate;background:radial-gradient(circle at 50% 46%,rgba(246,193,90,.17),transparent 43%),linear-gradient(180deg,rgba(20,16,9,.98),rgba(5,5,5,.98))}.mascot-stage:before{content:"";position:absolute;inset:10% 12% 13%;border-radius:50%;background:radial-gradient(circle,rgba(255,223,142,.28) 0%,rgba(212,175,55,.18) 28%,rgba(212,175,55,.07) 53%,transparent 72%);filter:blur(22px);animation:mascotGlow 3.6s ease-in-out infinite;z-index:0}.mascot-glow{position:absolute;width:72%;height:72%;border-radius:50%;background:radial-gradient(circle,rgba(255,236,181,.22),rgba(212,175,55,.10) 38%,transparent 70%);filter:blur(18px);z-index:0}.mascot-frame{position:relative;z-index:2;width:min(78%,310px);aspect-ratio:3/4.05;border-radius:28px;overflow:hidden;border:1px solid rgba(246,193,90,.42);background:#efe8db;box-shadow:0 24px 60px rgba(0,0,0,.55),0 0 0 1px rgba(255,255,255,.06),0 0 42px rgba(212,175,55,.22)}.mascot-frame:after{content:"";position:absolute;inset:0;border-radius:inherit;box-shadow:inset 0 0 38px rgba(99,63,9,.13),inset 0 1px rgba(255,255,255,.45);pointer-events:none}.mascot-video{display:block;width:100%;height:100%;object-fit:cover;object-position:center center;background:#efe8db}.mascot-nameplate{position:absolute;z-index:3;left:50%;bottom:17px;transform:translateX(-50%);display:flex;min-width:210px;flex-direction:column;align-items:center;border:1px solid rgba(246,193,90,.38);border-radius:16px;background:linear-gradient(180deg,rgba(10,9,6,.92),rgba(22,16,7,.90));padding:8px 16px 9px;box-shadow:0 12px 32px rgba(0,0,0,.45),0 0 22px rgba(212,175,55,.13);backdrop-filter:blur(12px)}.mascot-nameplate span{color:#f7d982;font-size:8px;font-weight:1000;letter-spacing:.28em}.mascot-nameplate strong{margin-top:2px;color:#fff4c3;font-size:16px;font-weight:1000;letter-spacing:.08em}.mascot-nameplate small{margin-top:2px;color:rgba(255,255,255,.62);font-size:9px;font-weight:850;letter-spacing:.06em}@keyframes mascotGlow{0%,100%{opacity:.68;transform:scale(.96)}50%{opacity:1;transform:scale(1.04)}}@media(max-width:759px){.mascot-stage{min-height:340px;padding:16px 16px 58px}.mascot-frame{width:min(70%,250px)}.mascot-nameplate{bottom:13px}}@media(max-width:390px){.hero-copy h1{font-size:34px}.trust-row{grid-template-columns:1fr}.benefit-grid{grid-template-columns:1fr}.hero-visual{min-height:255px}.float-card{transform:none!important}.v1{right:10px;top:22px}.v2{right:10px;top:108px}.v3{right:18px;bottom:28px}.home-model{left:30%;top:100px;transform:scale(.8)}}
      `}</style>
    </main>
  );
}

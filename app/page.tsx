...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#07101c] text-white">
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#06101d]/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1540px] items-center justify-between gap-4 px-4 py-4 lg:px-8">
          <a href="/" className="flex shrink-0 items-center gap-3">
            <div className="grid h-12 w-12 place-items-center rounded-2xl border border-[#d9a94e]/80 bg-[#081827] text-[#f6c15a]">⌂</div>
          ...
          <div className="hidden items-center gap-6 text-sm font-black lg:flex">
            <a href="#home">Home</a>
            <a href="#how">How It Works</a>
            <a href="#network">Our Network</a>
            <a href="#protection">Protection Shield</a>
      ...
      <section id="home" className="relative overflow-hidden bg-[radial-gradient(circle_at_25%_8%,rgba(246,190,78,.12),transparent_28%),linear-gradient(135deg,#08111f_0%,#071421_55%,#030912_100%)] px-3 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-[1540px] rounded-[34px] border border-white/10 bg-[#071421]/92 p-5 shadow-2xl shadow-black/30 sm:p-8 lg:p-12">
          <div className="grid gap-8 xl:grid-cols-[.9fr_1.1fr] xl:items-start">
            <div className="pt-10 xl:pt-36">
            ...
            <div>
              <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[#101827] shadow-2xl">
                <img src="/hero-couple-clean.png" alt="HELOC CONNECT office consultation" className="h-[360px] w-full object-cover object-center lg:h-[560px]" />
              </div>

              <div className="mx-auto mt-6 max-w-[700px] rounded-[30px] border border-[#d6c8ae]/80 bg-[#d7d0c2] p-6 text-[#0c1728] shadow-2xl">
                <div className="flex gap-4">
                  <div className="grid h-16 w-16 shrink-0 place-items-center rounded-full bg-[#0fa06f] text-4xl font-black text-white">✓</div>
                  <div>
                    <h3 className="text-3xl font-black leading-tight tracking-[-.04em]">Matched With A Mortgage Company That Fits Their Goals</h3>
                    <p className="mt-3 text-lg font-black text-[#007a56]">Example: lower monthly payment + $100,000 cash access</p>
                  </div>
                </div>
                <div className="mt-6 grid grid-cols-[1fr_auto_1fr] items-center gap-5">
                  <div className="rounded-2xl border border-slate-200 bg-white/80 p-5 text-center">
                    ...
                    <div className="mt-3 text-4xl font-black text-red-600">$2,785<span className="text-sm">/mo</span></div>
                    <div className="mt-3 text-sm font-black text-slate-600">$0 Cash Out</div>
                  </div>
                  <div className="text-5xl font-black text-slate-500">→</div>
                  <div className="rounded-2xl border border-emerald-300 bg-emerald-50/80 p-5 text-center">
                    <div className="text-sm font-black text-slate-500">Selected Network Company</div>
                    <div className="mt-3 text-4xl font-black text-emerald-700">$2,125<span className="text-sm">/mo</span></div>
                    <div className="mt-3 text-2xl font-black text-emerald-700">$100,000</div>
                  </div>
                </div>
                <div className="mt-5 rounded-2xl bg-[#0fa06f] px-4 py-4 text-center text-lg font-black text-white">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div key={title} className="rounded-2xl border border-white/10 bg-[#08182b] p-5">
          ...
          <div className="mt-8 flex flex-col gap-4 rounded-2xl border border-[#d9a94e]/60 bg-[#08182b] p-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="text-xl font-black text-[#f6c15a]">Ready to see your options?</h3>
              <p className="text-sm font-bold text-white/85">Scroll down and start with your property address. It only takes a minute.</p>
            </div>
            <a href="#apply" className="rounded-2xl bg-gradient-to-b from-[#ffd36d] to-[#d89425] px-8 py-4 text-sm font-black text-[#06101d]">Start Below ↓</a>
          </div>
        </div>
      </section>

      <section id="apply" className="mx-auto max-w-[1540px] px-3 py-8 sm:px-6 lg:px-8">
        <form onSubmit={submitLead} className="grid gap-5 rounded-[34px] border border-white/10 bg-[#071421] p-5 shadow-2xl sm:p-8 lg:p-10">
          <div className="rounded-[28px] border border-white/10 bg-gradient-to-br from-white/[.09] to-white/[.03] p-6">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex shrink-0 flex-col gap-2">
                <div className="rounded-full border border-emerald-300/35 bg-emerald-400/15 px-5 py-2 text-sm font-black text-emerald-200">● Powered by property data</div>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-[24px] border border-[#d9a94e]/45 bg-[#091a2f] p-5">
              ...
              <input name="street_address" value={street} onChange={(e) => setStreet(e.target.value)} placeholder="Start typing property address" required className="mt-3 w-full rounded-2xl border border-white/15 bg-[#06101d] p-4 outline-none focus:border-[#f6c15a]" />
            ...
            <div className="rounded-[24px] border border-white/10 bg-[#091a2f] p-5">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                <input name="home_value" value={displayMoney(homeValueInput)} onChange={(e) => setHomeValueInput(e.target.value)} placeholder="Estimated Home Value" className="rounded-2xl border border-white/15 bg-[#06101d] p-4 outline-none" />
                <input name="mortgage_balance" value={displayMoney(mortgageBalanceInput)} onChange={(e) => setMortgageBalanceInput(e.target.value)} placeholder="Mortgage Balance" className="rounded-2xl border border-white/15 bg-[#06101d] p-4 outline-none" />
                <input name="requested_cash" value={displayMoney(requestedCashInput)} onChange={(e) => setRequestedCashInput(e.target.value)} placeholder="Requested Funding Amount" className="rounded-2xl border border-white/15 bg-[#06101d] p-4 outline-none sm:col-span-2" />
              </div>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
      ...
      <section id="trust" className="mx-auto max-w-[1540px] px-3 pb-8 sm:px-6 lg:px-8">

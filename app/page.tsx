      ...
      <header className="sticky top-0 z-50 border-b border-amber-200/10 bg-[#050505]/95 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
          <a href="/" className="flex items-center gap-3">
            <div className="grid h-10 w-10 place-items-center rounded-2xl border border-amber-300/40 bg-amber-300/10 text-xl shadow-[0_0_28px_rgba(246,193,90,.18)]">⌂</div>
            <div><div className="text-base font-black tracking-[.22em]">HELOC</div><div className="text-[10px] font-black tracking-[.42em] text-amber-300">CONNECT</div></div>
          </a>

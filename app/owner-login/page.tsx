  ...
  return (
    <main className="min-h-screen bg-[#06111f] px-5 py-10 text-white">
      <div className="mx-auto flex min-h-[80vh] max-w-xl items-center justify-center">
        <form method="post" action="/api/auth/owner-login" className="w-full rounded-[34px] border border-white/10 bg-[#071421] p-8 shadow-2xl">
          ...
          <label className="mt-6 block text-sm font-black uppercase tracking-[.2em] text-[#f6c15a]">Password</label>
